...
class PyMove:
    ...
    def move_error(self, error_buffer=None):
        """
...
class PyMoveSplitter:
    ...
    def __init__(self, min_cruise_ratio=0.5, split_delta_z=0.025):
        """
    ...
    def initialize(self, max_velocity, max_accel, max_accel_to_decel,
    ...
    def build_move(self, start_pos, end_pos, speed):
        """
    ...
    def build_move_and_split(self, start_pos, end_pos, speed):
        """

...
class Motor_Control:
    ...
    def button_stall_pin_init(self):
    ...
    def data_pack(self, motor_num, cmd, data_list):
        """
    ...
    def data_pack_extruder(self, cmd, data_list):
    ...
    def bytes_to_int(self, data, signed=False):
    ...
    def validate_param(self, param, param_type):
    ...
    def validate_num_params(self, gcmd, param_name):
        """Validate numeric parameter."""
        return gcmd.get_int(param_name, default=1)

    def validate_data_params(self, gcmd, param_name):
        """Validate data parameter."""
        return gcmd.get_int(param_name, default=0)

    def validate_id_params(self, gcmd, param_name):
        """Validate ID parameter."""
        return gcmd.get_int(param_name, default=0)

    def validate_param_type_params(self, gcmd, param_name):
        """Validate parameter type."""
        return gcmd.get(param_name, 'int')

    def check_and_retry(self, func, *args, max_retries=3):
    ...
    def check_protection_code(self, axis):
    ...
    def check_motor_pin_io(self, pin):
    ...
    def check_motor_pin_io_restore(self, pin):
    ...
    def motor_sys_param_init(self, num):
    ...
    def motor_extruder_sys_param_init(self):
    ...
    def motor_extruder_read485_addr(self):
    ...
    def motor_extruder_set485_addr(self, addr):
    ...
    def motor_extruder_elec_offset_calibrate(self):
    ...
    def motor_extruder_encoder_calibrate_official(self):
    ...
    def set_motor_pin(self, pin, value):
        """Set motor GPIO pin value."""
        logging.debug("set_motor_pin %s = %d", pin, value)

    def set_motor_pin_dir(self, motor, direction):
    ...
    def set_motor_pin_normal(self, motor):
    ...
    def set_z_stall_mode(self, mode):
    ...
    def set_e_stall_mode(self, mode):
